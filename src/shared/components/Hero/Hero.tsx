...
const Hero = () => {
  ...
  return (
    <div className="w-full mb-6 lg:mb-0 mx-auto relative bg-white text-center dark:bg-[#05151e] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0">
      <img
        src={img}
      ...
      <div className="pt-[100px] pb-8">
        ...
        <h3 className="mb-4 text-[#7B7B7B] inline-block dark:bg-[#121e26] px-5 py-1.5 rounded-lg dark:text-[#A6A6A6]">
          Software Engineer
        </h3>
        ...
        <div className="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#121e26]">
